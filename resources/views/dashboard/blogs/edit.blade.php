...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="POST" action="/dashboard/blogs/{{ $blog_slug }}">
            @method("put")
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input id="body" type="hidden" name="body" class="@error('body') is-invalid @enderror" value="{{ old('body', $body) }}">
